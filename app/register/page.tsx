        ...
        <form onSubmit={handleSubmit} className="relative bg-white rounded-lg shadow-xl p-8 space-y-6 border-4 border-amber-100">
          <div className="text-center space-y-4">
            ...
            <h1 className="text-3xl font-bold text-amber-900 font-[Pacifico]">
              Loaf
              <span className="block text-xl text-amber-600 mt-1">Cadastre-se na Loaf</span>
            </h1>
          </div>
          ...
          <p className="text-center text-sm text-amber-700">
            Juntando-se à nossa fornada, você aceita nossos 
            <a href="#" className="ml-1 underline hover:text-amber-900">Termos de Massa</a>
          </p>
        </form>
      </div>
    </main>
